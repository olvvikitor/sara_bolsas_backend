...
export class UpdadeProductDto {
  ...
  @ApiProperty({
    description: 'Imagens externas a ser removidas',
  })
  ...
  @ApiPropertyOptional({
    description: 'Imagens exetrna para adicionar ao produto',
    required: false,
    type: 'array',
    items:{
      type:'string',
  ...
  @ApiPropertyOptional({
    description: 'Imagens internas para adicionar ao produto',
    type: 'array',
    items: {
      type: 'string',
      format: 'binary',
